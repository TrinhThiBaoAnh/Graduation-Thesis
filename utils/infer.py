...
def predict(numIters, mask_path, image_path, testsize):
    ...
    gt_image.save(os.path.join(save_dir, 'gt_image.png'))
    pred_image.save(os.path.join(save_dir, 'pred_image.png'))
...
if __name__ == "__main__":
    ...
    init_trainsize = 352
    mask_path = "/home/baoanh/baoanh/DATN/dataset/7 Loét HTT/mask_images/129.png"
    image_path = "/home/baoanh/baoanh/DATN/dataset/7 Loét HTT/images/129.jpeg"
    mask_file, predicted_file = predict(1, mask_path, image_path, init_trainsize )
    calculateMetrics(mask_file, predicted_file)